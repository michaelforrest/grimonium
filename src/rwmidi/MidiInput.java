...
//		}
		if (message instanceof javax.sound.midi.SysexMessage || message.getStatus() == (byte)0xF7) { // 11110111
			if (message.getStatus() == 0xF0) { // 11110000
//				System.out.println("clear message and start new ");
			...
			if (message.getStatus() >= 0xF8) { // 11111000
				return;
			} else {
				if (message.getStatus() == 0xF7) { // 11110111
	...
	public void plug(Object obj, int channel) {
		if (obj != null) {
			...
			plug(obj, "pitchBendReceived", channel, MidiEvent.PITCH_BEND);
		}
	}
